	...
	<div class="wrap_body">
		...
		<div class="body_content">
			...
			<div class="content_body">
				...
				<center>
				<br>
<!-- 				<button class="btn_box " id="" onclick="window.location='customer_manage.jsp'" type="button">goto customer list</button> -->
<!-- 				<button class="btn_box " id="" onclick="window.location='vehicle_manage.jsp'" type="button">goto vehicle list</button> -->
