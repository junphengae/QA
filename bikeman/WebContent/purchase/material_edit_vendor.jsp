		...
		<div class="body_content">
			...
			<div class="content_body">
					...
					<table width="100%">
						<tbody>
							<tr>
								...
								<td width="75%">: <%=MAT.getMat_code()%></td>
							</tr>
							<tr>
								<td>ชื่อสินค้า</td>
							...
							<tr>
								<td colspan="2" align="center" height="30">
									...
									<input type="hidden" name="mat_code" value="<%=MAT.getMat_code()%>">
								</td>
							</tr>
						</tbody>
					</table>
				...
				<table class="bg-image s700">
					...
					<%
					Iterator ite = InventoryMasterVendor.selectList(MAT.getMat_code()).iterator();
					while(ite.hasNext()) {
