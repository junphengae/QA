...
<form id="cutoff_form" onsubmit="return false;">
	...
	<table width="100%" class="center" id="tb_material_add" border="0" cellpadding="4" cellspacing="4">
		<tbody>
			<tr>
				<td width="25%" align="left">PN <%//=entity.getPn()%></td>
	...
	<div class="txt_center m_top20">
		...
		<input type="hidden" name="action" value="withdraw_parts">
		<input type="hidden" name="update_by" value="<%=securProfile.getPersonal().getPer_id()%>">			
		<input type="hidden" name="job_id" value="<%=entity.getId()%>">
	    <input type="hidden" name="draw_price" value="<%=entity.getPrice()%>">	
		<input type="hidden" name="draw_discount" value="<%=entity.getDiscount()%>">	
