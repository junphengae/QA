	...
	<div class="wrap_body">
		<div class="body_content">
			...
			<div class="content_body">
				<div class="left">
					<form style="margin: 0; padding: 0;" action="part_search.jsp" id="search" method="get">
						Keyword: 
				...
				<div class="right txt_center"><%=PageControl.navigator_en(ctrl,"part_search.jsp",paramList)%></div>
				<div class="clear"></div>
				...
				<table class="bg-image  s_auto breakword"><!-- เพิมbreakword มาเพื่อตัดคำ -->
					<thead>
						<tr valign="top" align="center">
							...
							<th width="9%" >Units</th>
							<th width="9%" >On Hand Qty</th>
							<th  width="10%">Price</th>
							<th  width="19%">Fit-To</th>
							<th  width="12%">SS</th>
					...
					%>
						...
						<tr>
							<td align="left" valign="top">
								<a href="part_info.jsp?pn=<%=entity.getPn().trim()%>&id=1"> <%=entity.getPn().trim() %> </a>
							</td>
							...
							<td align="left" valign="top"><%=entity.getFit_to()%></td>
							<td align="left" valign="top"><%=entity.getSs_no()%></td> 
