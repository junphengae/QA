			...
			submitHandler: function(){
				...
				$.post('../PartManagement',$form.serialize(),function(json){
					...
					if (json.status == 'success') {
						...
						$('#edit_group').fadeIn(500).attr('lang', 'part_group_edit.jsp?height=180&width=440&group_id=' + json.group_id);
						$('#new_cat').fadeIn(500).attr('lang','part_cat_new.jsp?height=180&width=440&group_id=' + json.group_id);
						$('#cat_id').html('<option value="">--- เลือกชนิด ---</option>');
	...
	<table cellpadding="3" cellspacing="3" border="0" style="margin: 0 auto;" width="420px">
		<tbody>
			...
			<tr>
				...
				<td>: <input type="text" autocomplete="off" name="group_name_en" id="group_name_en" class="txt_box s180 required" maxlength="10" ></td>
			</tr>
