		...
		<table width="100%" id="tb_invoice_detail">
			<tbody>
				...
				<tr>
					...
					<td>: <input type="text" class="txt_box required" name="serial" id="serial" autocomplete="off" title="*ระบุ Serial!"></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" align="center" height="30">
						...
						<input type="hidden" name="lot_qty" id="lot_qty" value="1">
