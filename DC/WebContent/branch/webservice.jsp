	...
	<div class="wrap_body">
		<div class="body_content">
			...
			<div class="content_body">
				<table width="100%">
					<tr>
						<th align="center" width="100%" colspan="1">
						อัพเดทข้อมูล
						</th>
					</tr>
					<tr>
					...
					<tr>
						<td  align="center">
							...
							<div class="table_name service_other_detail">
								<label>ID : </label><input type="text" name="start_other" class="txt_box s100 start_other txt_center">&nbsp;
								<label> ถึง </label>&nbsp;<input type="text" name="end_other" class="txt_box s100 end_other txt_center">&nbsp;&nbsp;&nbsp;
					...
					<tr>
						<td  align="center">
							...
							<div class="table_name service_part_detail">
								<label>ID : </label><input type="text" name="start_part" class="txt_box s100 start_part txt_center">&nbsp;
								<label> ถึง </label>&nbsp;<input type="text" name="end_part" class="txt_box s100 end_part txt_center">&nbsp;&nbsp;&nbsp;
					...
					<tr>
						<td  align="center">
							...
							<div class="table_name service_repair_detail">
								<label>ID : </label><input type="text" name="start_repair" class="txt_box s100 start_repair txt_center">&nbsp;
								<label> ถึง </label>&nbsp;<input type="text" name="end_repair" class="txt_box s100 end_repair txt_center">&nbsp;&nbsp;&nbsp;
