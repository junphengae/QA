		...
		if ($("#cus_name").val() != '') {
			...
			$.post('../PartSaleManage',$('#cus_form').serialize(),function(json){
				...
				if (json.status == 'success') {
					window.location='sale_part_update.jsp?id=' + json.id;
				} else {
					alert(json.message);
				}
			},'json');
	...
	<div class="wrap_body">
		<div class="body_content">
			<div class="content_head">
				<div class="left">Create Order</div>
				<div class="right">
					...
					<table class="s_auto">
						<tbody>
							<tr>
								...
								<td width="85%">: 
									<input type="text" class="txt_box s200" name="cus_name" autocomplete="off" id="cus_name" value="">
							...
							<tr>
								<td colspan="2" align="center">
									...
									<input type="hidden" name="service_type" value="<%=ServiceSale.SERVICE_SALE_PARTS%>">
