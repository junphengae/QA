		...
		<div class="body_content">
			...
			<div class="content_body">
				...
				<table class="columntop bg-image breakword "  width="100%">
						<thead>
							<tr>
								<th valign="top" align="center" width="12%">Create Date</th>
								<th valign="top" align="center" width="13%">PN</th>
								<th valign="top" align="center" width="30%">Description</th>					
								<th valign="top" align="center" width="7%">Units</th>
								<th valign="top" align="center" width="10%">PR QTY</th>
						...
						<tbody>
									<tr> 
									  <td colspan="8" style="padding: 0px 0px 0px 0px;" width="100%">
										  <div class="scroll">
									...
									<%
										...
										//	InventoryMasterVendor mVendor = entity.getUIInvVendor();
											...
											String UnitDesc = UnitType.selectName(PartMaster.SelectUnitDesc(master.getPn()));
											
									%>
										<tr valign="top">
											<td align="center" valign="top"width="12%"><%=WebUtils.getDateValue(entity.getCreate_date())%></td>
											<td align="left" valign="top"width="14%"><%=master.getPn()%></td>
											<td align="left" valign="top" width="30%">
											<!-- <div class="thickbox pointer" lang="../info/inv_master_info.jsp?width=800&height=380&mat_code=<% //=entity.getMat_code()%>" title="ข้อมูลสินค้า"></div> -->
											<%=master.getDescription()%>
											</td>
											<td align="left" valign="top" width="7%"><%=UnitDesc%></td>
											<td align="right" valign="top" width="10%"><%=Money.moneyInteger(entity.getOrder_qty())%></td>
											<td align="right" valign="top" width="10%"><%=Money.money(entity.getOrder_price())%></td>											
											<td align="center" valign="top" width="10%"><%=PurchaseRequest.status(entity.getStatus())%></td>
											<td align="center" valign="top" width="8%">
												...
												<a class="btn_update thickbox" title="Update PR / แก้ไขการขอจัดซื้อ" href="pr_parts_update.jsp?mat_code=<%=entity.getMat_code()%>&id=<%=entity.getId()%>&width=850&height=200"></a>
