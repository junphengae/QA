		...
		<div class="body_content">
			...
			<div class="content_body">
				...
				<table class="bg-image  s_auto breakword"><!-- เพิมbreakword มาเพื่อตัดคำ -->
					<thead>
						<tr>
							<th valign="top" align="center" width="20%" >P/N</th>
							<!-- <th valign="top" align="center" width="10%">กลุ่ม</th> -->
							<th valign="top" align="center" width="30%">Description</th>
							<th valign="top" align="center" width="15%">Units</th>
					...
					<%
						...
						while(ite.hasNext()) {
							...
							//System.out.println("entity.getDes_unit()::"+entity.getDes_unit());
					%>
						<tr>
							...
							<td align="left" valign="top"><%=UnitType.selectName(entity.getDes_unit())%></td>
							...
							<td align="center" valign="top">
								...
								<a class="btn_packing" href="packing_view.jsp?mat_code=<%=entity.getPn()%>" title="View Packing"></a>
							</td>
						</tr>
					<%
						}
