		...
		<div class="body_content">
			...
			<div class="content_body">
				<fieldset class="fset s450 left min_h300">
					...
					<div class="center txt_center"><button class="btn_box btn_confirm thickbox" type="button" lang="emp_edit.jsp?per_id=<%=per_id%>&height=350&width=440" onclick="windows.open">แก้ไข</button></div>
				...
				<fieldset class="fset s450 right min_h300">
					...
					<div class="center txt_center"><button class="btn_box btn_confirm thickbox" type="button" lang="emp_edit_detail.jsp?per_id=<%=per_id%>&height=280&width=450" onclick="windows.open">
						<%-- <button class="btn_box btn_confirm" onclick="javascript: window.location='emp_edit_detail.jsp?per_id=<%=per_id%>';">แก้ไข</button> --%>แก้ไข</button></div>
				</fieldset>
				<div class="clear"></div>
				<%-- <fieldset class="fset">
						...
						<tbody>
							...
							<tr>
								...
								<td align="left">: 
									...
									&nbsp;<button id="btn_chg_salary" class="btn_box thickbox" lang="emp_salary_edit.jsp?per_id=<%=per_id%>&salary=<%=salary.getSalary() %>" title="แก้ไขข้อมูลฐานเงินเดือนพนักงาน" >แก้ไขฐานเงินเดือน</button>
									<%} %>
								</td>
							</tr>
