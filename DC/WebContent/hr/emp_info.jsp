		...
		<div class="body_content">
			...
			<div class="content_body">
				<fieldset class="fset s450 left min_h300">
					...
					<table cellpadding="3" cellspacing="3" border="0"  width="100%">
						<tbody>
							...
							<tr>
								...
								<td align="left">: 
									<%=per.getTag_id() %>
									<button id="btn_emp_id" class="btn_box thickbox" lang="emp_id.jsp?per_id=<%=per_id%>&height=100" title="กำหนดรหัสพนักงาน"> กำหนดรหัสพนักงาน </button>
								</td>
							</tr>
					...
					<div class="center txt_center"><%-- <button class="btn_box btn_confirm" onclick="javascript: window.location='emp_edit.jsp?per_id=<%=per_id%>';">แก้ไข</button> --%>
													<button id="btn_emp_id" class="btn_box thickbox" lang="emp_edit.jsp?per_id=<%=per_id%>&height=350" title="แก้ไขข้อมูลพื้นฐานพนักงาน"> แก้ไข </button>
					</div>
				</fieldset>
				...
				<fieldset class="fset s450 right min_h300">
					...
					<table cellpadding="3" cellspacing="3" border="0"  width="100%">
						...
						<div class="center txt_center"><%-- <button class="btn_box btn_confirm" onclick="javascript: window.location='emp_edit_detail.jsp?per_id=<%=per_id%>';">แก้ไข</button> --%>
														<button id="btn_emp_id1" class="btn_box thickbox" lang="emp_edit_detail.jsp?per_id=<%=per_id%>&height=250" title="แก้ไขข้อมูลเพิ่มเติมพนักงาน">แก้ไข </button>
						</div>
				</fieldset>
				<div class="clear"></div>
