	...
	<table width="100%" class="center" id="tb_material_add" border="0" cellpadding="4" cellspacing="4">
		<tbody>
			...
			<tr>
				...
				<td align="left">: &nbsp;&nbsp;&nbsp;<input type="text" name="labor_rate" id="labor_rate" class="txt_box" autocomplete="off" value="0" onblur="calculateNetPrice()" onchange="calculateNetPrice()" onchange="return validCurrencyOnKeyUp(this, event)" ></td>
			</tr>
			<tr>
