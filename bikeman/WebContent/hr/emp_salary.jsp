				...
				<table cellpadding="3" cellspacing="3" border="0" class="center s550">
					<tbody>
						...
						<tr>
							...
							<td align="left">: <input value="<%=salary.getLimit_vacation()%>" type="text" autocomplete="off" size="30" name="limit_vacation" id="limit_vacation" class="txt_box s100  digits "  title="ต้องเป็นตัวเลขเท่านั้น">
								&nbsp;
								<!-- วัน --></td>
						</tr>
						<tr>
							...
							<td align="left">: 
								<input value="<%=salary.getLimit_sick()%>" type="text" autocomplete="off" size="30" name="limit_sick" id="limit_sick" class="txt_box s100 digits "  title="ต้องเป็นตัวเลขเท่านั้น">
								<!-- &nbsp;วัน -->
						...
						<tr>
							...
							<td align="left">: 
							<input value="<%=salary.getLimit_business()%>" type="text" autocomplete="off" size="30" name="limit_business" id="limit_business" class="txt_box s100 digits "  title="ต้องเป็นตัวเลขเท่านั้น">
							&nbsp;<!-- วัน -->
							</td>
						</tr>
