							...
							<table width="100%">
								<tbody>
									...
									<tr>
										...
										<td width="70%">: <%=WebUtils.getReqString(request,"order_id")%></td>
									</tr>
									<tr id="tr_lot_no">
										<td>หมายเลข Serial</td>
										<td>: <input type="text" autocomplete="off" name="serial" id="serial" class="txt_box s150 required" title="*"></td>
									</tr>
									<tr>
										<td>วันที่เบิกออก</td>
										<td>: <input type="text" autocomplete="off" name="request_date" id="request_date" class="txt_box s150 required" title="*"></td>
									</tr>
									...
									<tr>
										<td colspan="2" align="center">
											...
											<input type="hidden" name="request_no" value="<%=WebUtils.getReqString(request,"order_id")%>"> 
											<button type="submit" class="btn_box" id="btn_withdraw">เบิกสินค้า</button>
