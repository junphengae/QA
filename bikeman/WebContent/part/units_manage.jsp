	...
	<div class="wrap_body">
		<div class="body_content">
			...
			<div class="content_body">
				<div class="left">
					<form style="margin: 0; padding: 0;" action="units_manage.jsp" id="search" method="get">
						Keyword: 
				...
				<div class="right txt_center"><%=PageControl.navigator_en(ctrl,"units_manage.jsp",paramList)%></div>
				<div class="clear"></div>
			    ...
			    <table class="columntop bg-image breakword" width="100%">
					<thead>
						<tr>
								<th valign="top" align="center" width="23%" >Part Number</th>
								<th valign="top" align="center" width="34%" >Description</th>
								<th valign="top" align="center" width="16%">Units</th>
								<th valign="top" align="center" width="12%">Quantity</th>								
								<th align="center" width="13%"></th>													
						</tr>
					</thead>
					<tbody >
					  <tr> 
						 <td colspan="5" style="padding: 0px 0px 0px 0px;" width="100%">
							 <div class="scroll">
					...
					%>
						<tr>
							<td align="left" valign="top" width="23%"><%=entity.getPn().trim()%></td>
							<td align="left" valign="top" width="30%" ><%=entity.getDescription().trim() %></td>
							<td align="left" valign="top" width="15%"><%=UnitType.selectName(entity.getDes_unit())%></td>
							<td align="right" valign="top" width="10%"><%=entity.getQty()%></td>							
							<td align="left" valign="top" width="11%">
								<a class="btn_view" href="part_unit_info.jsp?pn=<%=entity.getPn()%>&id=1" title="View Parts Information"></a>
					...
					<%
						...
						if(has){
					%>
						<tr><td colspan="5" align="center">Parts Master cannot be found!</td></tr>
					<%
						}
					%>
