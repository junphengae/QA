				...
				<table class="bg-image  s_auto breakword"><!-- เพิมbreakword มาเพื่อตัดคำ -->
					<thead>
						<tr>
							...
							<th valign="top" align="center" width="15%">หน่วยนับ</th>
					...
					%>
						<tr>
							...
							<td align="left" valign="top"><%=entity.getDes_unit() %></td>
							<td align="left" valign="top">
								<a class="btn_view" href="part_info.jsp?pn=<%=entity.getPn()%>&id=1" title="View Parts Information"></a>
								<a class="btn_packing" href="packing_view.jsp?pn=<%=entity.getPn()%>" title="View Packing"></a>
							</td>
						</tr>
					<%
						}
