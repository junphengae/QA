		...
		<div class="body_content">
			...
			<div class="content_body">
				<div class="txt_center">
					<form style="margin: 0; padding: 0;" action="po_restatus.jsp" id="search" method="get">
						สถานะ: 
				...
				<div class="clear"></div>
				<div class="right txt_center"><%=PageControl.navigator_en(ctrl,"po_restatus.jsp",paramList)%></div>
				<div class="clear"></div>
							  ...
							  <table class="bg-image breakword"  style="border-collapse: collapse;" width="100%">
										...
										%>
											<tr>
												...
												<input type="button"  class="thickbox pointer btn_box" value="ดู" title="ดูรายละเอียดใบสั่งซื้อ" lang="po_info_review.jsp?po=<%=entity.getPo()%>&width=1000&height=700" > 
												<input type="button"  class="thickbox pointer btn_restatus"  title="แก้ไขสถานะใบสั่งซื้อ" lang="po_re_status.jsp?po=<%=entity.getPo()%>&status=<%=entity.getStatus()%>&width=500&height=190" > 
