								...
								<table class="s_auto" cellspacing="5">
									<tbody valign="top">
										...
										<tr>
											...
											<td>:</td>
											<td>
												<bmp:ComboBox name="repair_type" listData="<%=ServiceRepair.ddl_repair_type_th()%>" value="" styleClass="txt_box s150"></bmp:ComboBox>
											</td>
										</tr>
										<tr>
											...
											<td>:</td>
											<td>
												<input type="text" class="txt_box s150 " autocomplete="off" name="mile" value=""  id="mile">
												<br/>
