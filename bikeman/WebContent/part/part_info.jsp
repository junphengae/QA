					...
					<table cellpadding="3" cellspacing="3" border="0" class="s400 center m_left30">
						<tbody>
							...
							<tr>
								...
								<td>
								<% if(entity.getPn().equalsIgnoreCase("N-TAF-SPARK 135")){ %>
								<button class="btn_box thickbox" title="Edit" lang="location_edit.jsp?height=100&width=350&pn=N-TAF-SPARK">Edit</button>
								<% }else{ %>
								<button class="btn_box thickbox" title="Edit" lang="location_edit.jsp?height=100&width=350&pn=<%=entity.getPn().trim()%>">Edit</button>
								<% } %>
								</td>
							</tr>
						</tbody>
