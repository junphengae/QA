	...
	<div class="wrap_body">
		<div class="body_content">
			<div class="content_head">
				...
				<div class="right">
					<!-- <button class="btn_box btn_add" title="Choose Vehicle Spec" onclick="window.location='vehicle_spec_manage.jsp';">Choose Vehicle Spec</button> -->
					<button class="btn_box btn_search" title="Customer List" onclick="window.location='customer_manage.jsp';">Search Customer</button>
				</div>
				<div class="clear"></div>
			</div>
					...
					%>
						<tr>
							...
							<td align="center">
								...
								<%}%>
								<a class="btn_repair" href="vehicle_info.jsp?id=<%=entity.getId()%>" title="View Vehicle Information"></a>
							</td>
						</tr>
					<%
						}
						if(has){
					%>
						<!-- <tr><td colspan="6" align="center">Vehicle cannot be found : <button class="btn_box btn_add" onclick="window.location='vehicle_add.jsp';">Create New Vehicle</button></td></tr> -->
						<tr><td colspan="6" align="center">Cannot be found : <button class="btn_box btn_search" onclick="window.location='customer_manage.jsp';">Search Customer</button></td></tr>
					<%
						}
					%>
					</tbody>
