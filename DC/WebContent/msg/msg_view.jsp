	...
	<div class="wrap_body">
		<div class="body_content">
			<div class="content_head">
				<b>View Message</b> 
				<button class="btn_box right m_right15" onclick="javascript: window.location='<%=LinkControl.link("msg_list.jsp", (List)session.getAttribute("MSG_SEARCH"))%>';">back</button> 
			</div>
