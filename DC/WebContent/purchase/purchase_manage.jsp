				...
				<table class="bg-image  s_auto breakword"><!-- เพิมbreakword มาเพื่อตัดคำ -->
					<thead>
						<tr>
							...
							<th valign="top" align="left" width="6%">กลุ่ม</th>
							<th valign="top" align="left" width="6%">ชนิด</th>
							<th valign="top" align="left" width="6%">ชนิดย่อย</th>
							<th valign="top" align="left" width="15%" >Description</th>
							<th valign="top" align="left" width="12%">Fit-To</th>
							<th valign="top" align="center" width="2%">SS</th>
							<th valign="top" align="center" width="2%">Units</th>
							<th valign="top" align="right" width="5%">Qty</th>
							<th valign="top" align="center" width="5%">MOR</th>
							<th valign="top" align="center" width="5%">MOQ</th>
							<th valign="top" align="left" width="7%">PR Qty</th>
							<th valign="top" align="left" width="7%">PO Qty</th>
					...
					<%
						...
						while(ite.hasNext()) {
							...
							sumPR = "0";
							sumPO = "0";
							if(PurchaseRequest.sumPR(entity.getPn()).length()>0){
								sumPR = PurchaseRequest.sumPR(entity.getPn());
							}
					...
					%>
						<tr>
							...
							<td align="right" valign="top"><%=Money.moneyInteger(entity.getMor())%></td> 
							<td align="right" valign="top"><%=Money.moneyInteger(entity.getMoq())%></td> 
							<td align="right" valign="top"> <%=Money.moneyInteger(sumPR)%></td> 
							<td align="right" valign="top"><%=Money.moneyInteger(sumPO)%></td> 
							<td align="left" valign="top">
							 <input type="hidden" name="pn" id="pn" value="<%=pn%>">
							 <input type="hidden" name="action" id="action" value="selectCheck">
							<a class="btn_view" href="part_info.jsp?pn=<%=entity.getPn()%>" title="View Parts Information"></a>
								
							<button class="btn_import thickbox"  title="Purchase Parts" lang="pr_parts.jsp?pn=<%=entity.getPn()%>&width=850&height=500"></button>
