					...
					<form id="issue_po_form" onsubmit="return false;">
						...
						<div class="po_head s350 right">
							<table>
								...
								<tr>
									<td>กำหนดส่ง (Delivery Date) </td><td>: <input type="text" name="delivery_date" id="delivery_date"  readonly="readonly" class="txt_box s150" value="<%=(PO.getDelivery_date()==null)?"":WebUtils.getDateValue(PO.getDelivery_date())%>"></td>
								</tr>
							</table>
						</div>
						<div class="clear"></div>
							...
							<table class="bg-image s950">
								...
								%>
									...
									<tr>
										...
										<td align="right">
											<input type="text" class="txt_box s_auto txt_right" name="discount_show" id="discount_show" value="<%=PO.getDiscount()%>" autocomplete="off">
