			...
			<div class="content_body">
				...
				<fieldset class="fset s550 right min_h300">
					...
					<table class="bg-image s_auto" style="margin-top: 10px;">
						...
						<tbody>
							...
							<tr>
								...
								<td align="center">
									<a class="btn_view thickbox" title="Vehicle Information" lang="vehicle_info_popup.jsp?vid=<%=vehicle.getId()%>&master_id=<%=vmaster.getId()%>"></a>
									<a class="btn_update thickbox" title="Update Vehicle Information" lang="vehicle_edit.jsp?vid=<%=vehicle.getId()%>&cus_id=<%=entity.getCus_id()%>&master_id=<%=vmaster.getId() %>"></a>
								</td>
							</tr>
					...
					<div class="txt_center"> 
						<button class="btn_box" onclick="javascript: window.location='vehicle_spec_manage.jsp?SYSTEM=CS&cus_id=<%=entity.getCus_id()%>';">Search Vehicle Spec</button>
					</div>
				</fieldset>
