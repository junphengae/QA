...
System.out.println("OrderPrice out :"+entityPR.getOrder_price().trim());
if(entityPR.getOrder_price().trim().equalsIgnoreCase("")){
	String OrderPrice =	PurchaseRequest.selectOrderPrice(entityPR.getPo() ,entityPR.getId() ,entityPR.getMat_code());
	entityPR.setOrder_price(OrderPrice);
...
<!-- /************************************************************************************************************************/ -->
				  ...
				  <div id="div_non_sn" >		   					
							...
							<div class="left">		
									...
									<label for="upImg">รับเข้าปกติ</label>
