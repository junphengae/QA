			...
			<div class="content_body">
				<form id="infoForm" name="infoForm" action="" method="post" style="margin: 0;padding: 0;">
					<table cellpadding="3" cellspacing="3" border="0" class="center s480">
						...
						<tr height="20px">
							<td width="10%"><Strong>รหัสสาขา</Strong></td>
							<td align="left">: 
							...
							<td colspan="2" height="10px" >
								...
								<tr height="20px">
						 		...
						 		<tr height="20px">
									...
									<td align="left">: 
									<input type="text" maxlength="5" autocomplete="off" name="branch_postalcode" id="branch_postalcode"  class="txt_box s100 required" title="Please insert Postalcode."> 
									</td>
							 	</tr>
						  		<tr height="20px">
									<td><Strong>เบอร์โทรศัพท์</Strong></td>
									<td align="left">: 
									<input type="text" maxlength="10" autocomplete="off" name="branch_phonenumber" id="branch_phonenumber"  class="txt_box s120 " title="Please insert Phonenumber."> 
									</td>
						 		</tr>
						  		<tr height="20px">
									<td><Strong>แฟกซ์</Strong></td>
									<td align="left">: 
									<input type="text" maxlength="10" autocomplete="off" name="branch_fax" id="branch_fax"  class="txt_box s120 " title="Please insert Fax."> 
								</td>
							 	</tr>
