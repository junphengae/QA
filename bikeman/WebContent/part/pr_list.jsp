						...
						%>
							<tr valign="top">
								...
								<td align="center" valign="top">
									...
									<a class="btn_bin thickbox" title="Cancel PR / ยกเลิกการขอจัดซื้อ" href="pr_parts_cancel.jsp?mat_code=<%=entity.getMat_code()%>&id=<%=entity.getId()%>&width=450&height=250"></a>
