	...
	<div class="wrap_body">
		<div class="body_content">
			<div class="content_head">
				...
				<div class="right">
					<button class="btn_box" type="button" onclick="window.location='<%=LinkControl.link("purchase_manage.jsp", (List)session.getAttribute("PART_SEARCH"))%>';">back</button>
				</div>
				<div class="clear"></div>
			</div>
					...
					<table class="bg-image s_auto">
						...
						%>
							<tr id="vendor_<%=vendor.getVendor_id()%>">
								...
								<td align="center"><%=Money.moneyInteger(masterVendor.getVendor_moq()) %></td>
