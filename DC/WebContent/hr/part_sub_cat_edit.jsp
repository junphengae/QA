...
<%	
	...
	entity = PartCategoriesSub.select(entity);
%>
	...
	<table cellpadding="3" cellspacing="3" border="0" style="margin: 0 auto;" width="420px">
		<tbody>
			...
			<tr>
				...
				<td align="left" width="80%">: <input type="text" autocomplete="off" name="sub_cat_name_th" id="sub_cat_name_th" class="txt_box s200 required input_focus" value="<%=entity.getSub_cat_name_th()%>" ></td>
			</tr>
			<tr>
				<td><label>ชื่อย่อ</label></td>
				<td>: <input type="text" autocomplete="off" maxlength="10" name="sub_cat_name_short" id="sub_cat_name_short" class="txt_box s200 required" value="<%=entity.getSub_cat_name_short()%>"></td>
			</tr>
