				...
				<fieldset class="fset">
					...
					<table class="bg-image s_auto breakword columntop" style="border: 1px solid #555;">
						...
						<thead>
							<tr>
								...
								<th valign="top" align="center" width="5%">Order Qty</th>
						...
						<%
							...
							while(ite.hasNext()) {
								...
								total_price = MoneyDiscountRound.disRound(net_price, detailPart.getDiscount());
					...
					<table class="bg-image s_auto">
						...
						<%
							...
							while(iteSV.hasNext()) {
								...
								total = Money.add(total, total_price);
								net_price = detailRepair.getLabor_rate();
								total_price = MoneyDiscountRound.disRound(net_price, detailRepair.getDiscount());
					...
					<table class="bg-image s_auto breakword columntop">
						...
						<%				
							...
							while(iteOther.hasNext()) {
								...
								total_price = MoneyDiscountRound.disRound(net_price, detailOther.getDiscount());
								disc = Money.subtract(net_price, total_price);
					...
					<div class="dot_line"></div></td>
							...
							<tr>
								...
								<td align="right">
									 <input  type="text" class="txt_right required"  title="*****" name="received"  id="received" value="0.00" maxlength="19"  /> 
								</td>
							</tr>
														<tr>
