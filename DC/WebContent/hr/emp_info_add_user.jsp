				...
				<fieldset class="fset s450 right min_h300">
					...
					<table cellpadding="3" cellspacing="3" border="0"  width="100%">
						...
						<%-- <div class="center txt_center"><button class="btn_box btn_confirm" onclick="javascript: window.location='emp_edit_detail.jsp?per_id=<%=per_id%>';">แก้ไข</button></div> --%>
							<div class="center txt_center"><button class="btn_box btn_confirm thickbox" type="button" lang="emp_edit_detail.jsp?per_id=<%=per_id%>&height=280&width=450" onclick="windows.open">แก้ไข</button></div>
				</fieldset>
				<div class="clear"></div>
