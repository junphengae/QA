...
<%
	...
	entity = Categories.select(entity);
%>
	...
	<table cellpadding="3" cellspacing="3" border="0" style="margin: 0 auto;" width="485px">
		<tbody>
			...
			<tr>
				...
				<td align="left" width="75%">: <input type="text" autocomplete="off" name="cat_name_th" id="cat_name_th" class="txt_box s200 required input_focus" value="<%=entity.getCat_name_th()%>"></td>
			</tr>
			<tr>
				<td><label>ชื่อย่อ</label></td>
				<td>: <input type="text" autocomplete="off" name="cat_name_short" id="cat_name_short" class="txt_box s200 required" value="<%=entity.getCat_name_short()%>"></td>
			</tr>
