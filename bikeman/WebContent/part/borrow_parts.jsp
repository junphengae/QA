				...
				<table class="columntop bg-image breakword "  width="100%">
					<thead>
						<tr>
							...
							<th valign="top" align="center" width="22%">Description</th>
							<th valign="top" align="center" width="15%">Borrow By</th>
							<th valign="top" align="center" width="19%">Borrow Date</th>
							<th valign="top" align="center" width="7%">Units</th>
							<th valign="top" align="center" width="6%">Borrow Qty</th>
							<th valign="top" align="center" width="6%">Return Qty</th>
					    ...
					    <td colspan="8" style="padding: 0px 0px 0px 0px;" width="100%">
							 <div class="scroll">
							  <table class="bg-image breakword"  style="border-collapse: collapse;" width="100%">
										...
										%>
											<tr>
												<td align="left" width="14%"><%=entity.getPn() %></td>
												<td align="left" width="22%"><%=entity.getDescription() %></td>
												<td align="left" width="15%"><%=Personal.selectOnlyPerson(borrow.getBorrow_by()).getName()%></td>
												<td align="center" width="19%"><%=WebUtils.getDateTimeValue(borrow.getCreate_date())%></td>
												<td align="left" width="7%"><%=UnitDesc%></td>
												<td align="right" width="6%"><%=Money.moneyInteger( borrow.getQty() )%></td>
												<td align="right" width="6%"><%=Money.moneyInteger( borrow.getReturn_qty() )%></td>
