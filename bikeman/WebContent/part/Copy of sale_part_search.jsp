		...
		<div class="body_content">
			...
			<div class="content_body">
				...
				<table class="columntop bg-image breakword "  width="100%">
					<thead>
						<tr>
							<th valign="top" align="center" width="11.5%">P/N</th>
							<th valign="top" align="center" width="27.5%">Description</th>
						 ...
						 <td colspan="9" style="padding: 0px 0px 0px 0px;" width="100%">
							 <div class="scroll">
							  <table class="bg-image breakword"  style="border-collapse: collapse;" width="100%">							
													...
													%>
														<tr>
															<td width="12%"><font color="red"> <%=entity.getPn() %></font></td>
															<td width="28%"><font color="red"><%=entity.getDescription() %></font></td>
															<td width="10%"><font color="red"><%=entity.getFit_to() %></font></td>
															<td align="right" width="10%"><font color="red">
																<%=entity.getQty()%>
																</font>
															</td>
															<td align="right" width="10%"><font color="red">
																<%=UnitType.selectName(entity.getDes_unit())%></font>
															</td>
															<td align="right" width="10%"><font color="red">
																<%=Money.money(entity.getPrice())%></font>
															</td>
															...
															<td align="center" width="3%"><%if(entity.getSs_no().length() > 0){%><img src="../images/icon/flag.png" title="SS Flag"><%}%></td>
														...
														<tr>
															<td width="12%"><%=entity.getPn() %></td>
															<td width="28%"><%=entity.getDescription() %></td>
															<td width="10%"><%=entity.getFit_to() %></td>
															<td align="right"  width="10%">
																<%=entity.getQty()%>
															</td>
															<td align="right"  width="10%">
