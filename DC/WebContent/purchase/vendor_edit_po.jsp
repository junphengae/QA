...
<%@page import="net.sf.jasperreports.web.util.WebUtil"%>
	...
	<table cellpadding="3" cellspacing="3" border="0" style="margin: 0 auto;" width="485px">
		<tbody>
			...
			<tr>
				...
				<td align="left" width="75%">: <input type="text" autocomplete="off" name="vendor_name" id="vendor_name" class="txt_box s150 input_focus required" value="<%=entity.getVendor_name()%>"> 
				<button class="btn_box" onclick="javasript: window.location='po_issue_edit.jsp?po=<%=po%>';">เลือกตัวแทน</button>
				</td>
		...
		<%-- 	<tr>
				<td>ประเภท</td>
				<td>: 
					<bmp:ComboBox name="vendor_type" styleClass="txt_box s150" validate="true" validateTxt="*" value="<%=entity.getVendor_type()%>">
						<bmp:option value="" text="เลือก"></bmp:option>
						<bmp:option value="<%=Vendor.TYPE_GENERAL%>" text="ตัวแทนจำหน่ายทั่วไป"></bmp:option>
						<bmp:option value="<%=Vendor.TYPE_COCONUT%>" text="ตัวแทนจำหน่ายมะพร้าว"></bmp:option>
					</bmp:ComboBox>
				</td>
			</tr> --%>
			<tr>
				<td><label>โทรศัพท์</label></td>
				<td>: <input type="text" maxlength="10" autocomplete="off" name="vendor_phone" id="vendor_phone" class="txt_box s200" value="<%=entity.getVendor_phone()%>"></td>
			</tr>
			<tr>
				<td><label>แฟกซ์</label></td>
				<td>: <input type="text" maxlength="10" autocomplete="off" name="vendor_fax" id="vendor_fax" class="txt_box s200" value="<%=entity.getVendor_fax()%>"></td>
			</tr>
			<tr>
