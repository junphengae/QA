				...
				$.post('../OrgManagement',addData,function(resData){
					if (resData.status == "success") {
						...
						if (resData.check == 'success') {
							alert("แก้ไขข้อมูลฝ่ายเรียบรร้อยแล้ว");
							//$msg.text('Edit successful!').show();
...
<div>
	...
	<table cellpadding="3" cellspacing="3" border="0" style="margin: 0 auto;" width="455px">
		<tbody>
			<tr align="center" height="25"><td colspan="2"><h3>Edit Department Name</h3></td></tr>
			<tr>
			...
			<tr>
				<td><label>Department (Eng)</label></td>
