		...
		<div class="body_content">
			...
			<div class="content_body">
				...
				<table class="bg-image  s_auto breakword"><!-- เพิมbreakword มาเพื่อตัดคำ -->
					<thead>
						<tr align="center">
						<!--  	<th valign="top" align="left" width="10%" >ลำดับ</th> -->
							<th valign="top"  width="8%">รหัสสาขา</th>
							<th valign="top"  width="8%">ชื่อสาขา</th>
							<th valign="top"  width="10%" >ถนน/ซอย</th>
							<th valign="top"  width="6%">เลขที่</th>
							<th valign="top"  width="6%">หมู่ที่ </th> <!-- /หมู่บ้าน -->
							<th valign="top"  width="8%">ตำบล</th>
							<th valign="top"  width="8%">อำเภอ</th>
							<th valign="top"  width="8%">จังหวัด</th>
							<th valign="top" width="8%">รหัสไปรษณีย์</th>
							<th valign="top"  width="10%">เบอร์โทรศัพท์</th>
					...
					%>
						<tr>
							...
							&nbsp;
							<input id="edit_Branch" class="btn_box thickbox" type="button" lang="branch_edit.jsp?branch_id=<%=entity.getBranch_id() %>&height=450&width=450" value="แก้ไข" title="Edit Branch" onclick="windows.open"></td>
						</tr>
					<%} if(has){
					%>
							<tr><td colspan="8" align="center">---- ไม่พบข้อมูลสาขา---- </td></tr>
						<%
							}
						%>
