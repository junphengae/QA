			...
			submitHandler: function(){
				...
				$.post('../PartManagement',$form.serialize(),function(data){
					...
					if (data.status == 'success') {
						...
						$('#edit_sub_cat').fadeIn(500).attr('lang','part_sub_cat_edit.jsp?height=180&width=440&cat_id=' + data.cat_id + '&sub_cat_id=' + data.sub_cat_id + '&group_id=' + data.group_id);
						tb_remove();
					} else {
						alert(data.message);
	...
	<table cellpadding="3" cellspacing="3" border="0" style="margin: 0 auto;" width="420px">
		<tbody>
			...
			<tr>
				...
				<td>: <input type="text" autocomplete="off" name="sub_cat_name_short" id="sub_cat_name_short" class="txt_box s200 required"  maxlength="10"></td>
			</tr>
