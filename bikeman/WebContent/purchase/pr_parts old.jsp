		...
		<table class="s_auto">
			<tbody>
				<tr>
					...
					<td><input type="text" class="txt_box s_auto" autocomplete="off" name="note"></td>
				</tr>
		...
		<table class="bg-image s800" style="color: #fff;">
			<thead>
				<tr>
					...
					<th valign="top" align="center" width="25%">Vendor Name</th>
					<th valign="top" align="center" width="15%">MOQ</th>
					<th valign="top" align="center" width="15%">Lead-time</th>
					<th valign="top" align="center" width="20%">Condition</th>
					<th valign="top" align="center" width="20%">Credit</th>
				</tr>
			</thead>
			<tbody id="vendor_list">
				<tr>
					<td><input type="radio" name="vendor_id" value="cash"></td>
					<td><label title="เงินสด">Cash / เงินสด</label></td>
					<td></td>
					<td></td>
					<td></td>
					<td></td>
				...
				<%
					Iterator ite = PartVendor.selectList(pn).iterator();
						while(ite.hasNext()) {
					PartVendor pVendor = (PartVendor) ite.next();
					Vendor vendor = pVendor.getUIVendor();
				%>
				<tr id="vendor_<%=vendor.getVendor_id()%>">
					...
					<td align="center"><%=pVendor.getVendor_moq()%></td>
					<td align="center"><%=pVendor.getVendor_delivery_time()%></td>
