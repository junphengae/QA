...
$(function(){
	...
	var tr_type_summary = $('#tr_type_summary');
	var tr_type 		= $('#tr_type');
	tr_type.hide();
	$('#btn_view').click(function(){
			...
			if($('#report_type_summary').val() == "SUM_PO_STATUS"){
				if($('#report_type').val() == "" || $('#report_type').val() == "1"){
	...
	if(document.getElementById("report_type_summary").value != "1"){
			
			if (document.getElementById("report_type_summary").value == "SUM_PR"  || document.getElementById("report_type_summary").value == "SUM_PO" || document.getElementById("report_type_summary").value == "PR_LIST"){
	...
	$('#report_type_summary').change(function(){
		if(  ($('#report_type_summary').val() == "SUM_PO_STATUS") || ($('#report_type_summary').val() == "SUM_PR_STATUS")){
			tr_type.show();
		}else{
			tr_type.hide();
			tr_matcode.hide();
	...
	<div class="wrap_body">
		<div class="body_content">
			<div class="content_head">
				<Strong>รายงาน : </Strong>รายการใบสั่งซื้อ  : ตามสถานะ
			</div>
			
			<div class="content_body">
			<form id="report_form">
				<table>
					<tr id="tr_type_summary">
						<td>ประเภท</td>
						<td>:
						<bmp:ComboBox name="report_type_summary" styleClass="txt_box s320" value="">
								<bmp:option value=""  text="----------------  กรุณาเลือก   ---------------"></bmp:option>
								<bmp:option value="SUM_PR" text="สรุปการออก PR"></bmp:option> 
								<bmp:option value="SUM_PO" text="สรุปการออก PO "></bmp:option>
								<bmp:option value="SUM_PR_STATUS" text="รายการ  PR ตามสถานะ "></bmp:option>
								<bmp:option value="SUM_PO_STATUS" text="รายการ  PO ตามสถานะ "></bmp:option>
								<bmp:option value="PR_LIST" text="รายการสินค้าขอจัดซื้อ"></bmp:option>
							</bmp:ComboBox>
						</td>
					</tr>
					<tr id="tr_type">
						<td width="70">สถานะ</td><td>: 
							<bmp:ComboBox name="report_type" styleClass="txt_box s320" value="">
								<bmp:option value="1"  text="----------------  กรุณาเลือก   ---------------"></bmp:option>
								<bmp:option value="30" text="อนุมัติแล้ว"></bmp:option> 
								<bmp:option value="10" text="รออนุมัติ "></bmp:option>
								<bmp:option value="33" text="รอการแก้ไข "></bmp:option>
								<bmp:option value="35" text="ไม่อนุมัติ "></bmp:option>
								<bmp:option value="00" text="ยกเลิก"></bmp:option> 
								<bmp:option value="40" text="กำลังสร้าง PO"></bmp:option>
								<bmp:option value="41" text="เปิด PO"></bmp:option>
								<bmp:option value="42" text="ปิด PO"></bmp:option>
								<bmp:option value="45" text="ยกเลิก PO"></bmp:option>
					...
					<tr id="tr_matcode" class="hide">
						<td>PO/No.</td>
						<td>: 
							 <input type="text" class="txt_box" name="po" id="po">
						</td>
					</tr>
