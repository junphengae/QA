	...
	function dc(){
		...
		if (v == '0' || v == '') {
			...
			if (isNumber(v)) {
				...
				//f_discount_pc.val(discount_value(parseFloat(f_gross_amount.val()), v));
						...
						<div class="m_top5 center">
							...
							<table class="bg-image s950">
								...
								%>
									...
									<tr>
										<td colspan="4" align="right">ส่วนลด (Discount) <input type="text" class="txt_box s30 txt_center" name="discount_pc" id="discount_pc" value="<%=PO.getDiscount()%>"> %</td>
