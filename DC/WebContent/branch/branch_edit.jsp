...
<div>
		<fieldset class="fset s430 left min_h200">
					<legend><Strong>แก้ไขข้อมูลสาขา</Strong></legend>
				...
				<table cellpadding="3" cellspacing="3" border="0" style="margin: 0 auto;" width="420px">
					<tbody>
						...
						<tr>
							<td align="left" width="20%"><label><Strong>รหัสสาขา</Strong></label></td>
						...
						<%-- <tr height="20px">
							...
							<td>: <input type="text" autocomplete="off" name="branch_order" id="branch_order" class="txt_box s200 required" value="<%=entity.getBranch_order()%>" title="Please insert Branch Name."> </td>
						</tr> --%>
						<tr height="20px">
							<td><label><Strong>ชื่อสาขา</Strong></label></td>
						 ...
						 <tr height="20px">
							...
							<td align="left">: 
							<input type="text" autocomplete="off" name="branch_name_en" id="branch_name_en"  class="txt_box s200 required" value="<%=entity.getBranch_name_en()%>" title="Please insert Branch Name."> 
							</td>
						 </tr>
						</tbody>
					</table>
					<fieldset class="fset s380 left min_h200">
						...
						<table width="380px">
							<tr height="20px">
										...
										<tr height="20px">
											<td><Strong>บ้านเลขที่</Strong></td>
											<td align="left">: 
										...
										<tr height="20px">
											...
											<td align="left">: 
											<input type="text" maxlength="5" autocomplete="off" onkeyup='checkNumber_postalcode(this)' name="branch_postalcode" id="branch_postalcode" value="<%=entity.getBranch_postalcode() %>" class="txt_box s100 required" title="Please insert Postalcode."> 
											</td>
										</tr>
										<tr height="20px">
											<td><Strong>โทรศัพท์</Strong></td>
											<td align="left">: 
											<input type="text" maxlength="10" autocomplete="off" onkeyup='checkNumber_phonenumber(this)' name="branch_phonenumber" id="branch_phonenumber" value="<%=entity.getBranch_phonenumber() %>" class="txt_box s120 " title="Please insert Phonenumber."> 
											</td>
										<tr>
										<td><Strong>แฟกซ์</Strong></td>
											<td align="left">: 
											<input type="text" maxlength="10" autocomplete="off" onkeyup='checkNumber_fax(this)' name="branch_fax" id="branch_fax" value="<%=entity.getBranch_fax()%>" class="txt_box s120 " title="Please insert Fax."> 
											</td>
										</tr>
