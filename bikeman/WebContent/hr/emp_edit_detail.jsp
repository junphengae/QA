				...
				<table cellpadding="3" cellspacing="3" border="0" class="center s550">
					<tbody>
						<tr>
							...
							<td align="left">: <input value="<%=perDetail.getId_card()%>" maxlength="13" type="text" autocomplete="off" name="id_card" id="id_card" class="txt_box s200" ></td>
						</tr>					
						<tr>
						...
						<tr>
							...
							<td align="left">: <input value="<%=perDetail.getPhone()%>" maxlength="10" type="text" autocomplete="off" size="30" name="phone" id="phone" class="txt_box s200" ></td>
						</tr>
						<tr>
