		...
		<div class="body_content">
			...
			<div class="content_body">
				...
				<table class="bg-image breakword"  width="100%"><!-- เพิมbreakword มาเพื่อตัดคำ -->
					<thead>
						<tr>
							<th valign="top" align="center" width="10%">P/N</th>
							<th valign="top" align="center" width="21%">Description</th>
							<th valign="top" align="center" width="6%">กลุ่ม</th>
							<th valign="top" align="center" width="6%">ชนิด</th>
							...
							<th valign="top" align="center" width="5%">SS</th>
							<th valign="top" align="center" width="5%">Units</th>
							<th valign="top" align="center" width="11%">On Hand Qty</th> 
								...
								<table class="bg-image"  style="border-collapse: collapse;" width="100%" >
									...
									%>
										<tr>
											...
											<td align="left" valign="top" width="10%"><%=entity.getLocation().trim() %></td>
											<td align="left" valign="top" width="10%">
												<%=entity.getFit_to() %>
											</td>
											...
											<%=Money.moneyInteger(entity.getQty())%>
											</td>
