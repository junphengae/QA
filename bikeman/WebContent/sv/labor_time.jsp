				...
				function(data){
					...
					for (var i = 0; i < data.length; i++) {
						li += '<tr id="' + data[i].labor_id + '">'
							...
							+ '<td align="center">'
							+ '<input class="btn_update" lang="../info/labor_time_edit_edit.jsp?width=550&amp;height=250&amp;labor_id='+data[i].labor_id +'&amp;main_id='+data[i].main_id+'" type="button" title="แก้ไขรายการซ่อม" onclick="thickbox_init(this);" >'
							+ '</td></tr>';
					}
								...
								<script type="text/javascript">										
									$('#main_id').change(function(){
										if($(this).val() != "") {
											...
											$('#add_new_labortime').attr('lang','../info/labor_time_insert.jsp?width=550&height=250&main_id='+$(this).val());
										} else {
											$('#edit_main').hide();
											$('#new_main').fadeIn(500).attr('lang','../info/labor_main.jsp?width=550&height=250&cate_id='+ $('#cate_id').val());
