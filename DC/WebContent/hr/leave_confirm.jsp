			...
			submitHandler: function(){
				...
				$.post('../EmpManageServlet',addData,function(resData){
					if (resData.status == "success") {
						$msg.text('ยืนยันเรียบร้อยแล้ว').show();
...
<div>
	...
	<input type="hidden" name="status" id="status" value="<%=entity.getStatus()%>">
	<table cellpadding="3" cellspacing="3" border="0" style="margin: 0 auto;" width="455px">
		<tbody>
			<tr align="center" height="25"><td colspan="2"><h3>ยืนยันข้อมูลการขาด ลา มาสาย</h3></td></tr>
			<tr>
			...
			<tr align="center" valign="bottom" height="30">
				<td colspan="2">
					<input type="submit" id="btnAdd" value="ยืนยัน" class="btn_box">
					<input type="hidden" name="action" value="confirm_leave">
