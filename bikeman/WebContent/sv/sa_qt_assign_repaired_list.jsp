	...
	<div class="wrap_body">
		<div class="body_content">
			<div class="content_head">
				<div class="left">Assign Repaired List</div>
				<div class="right">
...
<div class="wrap_all">
	...
	<div class="wrap_navigate">
		...
		<span>Assign Repaired List</span>
	</div>
	<!-- Start Wrap Content -->
	<div class="wrap_content">
		...
		<div class="content">
			...
			<div class="box_wrap s1000">
				<div class="box_head">
					<div class="left txt_bold">ใบแจ้งซ่อมเลขที่: <%=repair_order.getId()%></div>
					
					<div class="clear"></div>
				</div>
				
				<div class="box_body">
					<fieldset class="fset s950 center" id="customer_info">
					...
					<fieldset class="fset s950" >
						...
						<div id="laborTimeGuide" class="center s950 hide">
							...
							<table class="bg-repair s950 center">
								<thead>
									<tr>
			...
			<div class="box_wrap s1000">
				<div class="box_head">
					<div class="left txt_bold">รายการซ่อม :</div>
					<div class="clear"></div> 
				</div>
					...
					<table class="bg-repair s950 center">
						...
						%>
							<tr id="list_<%=labor.getLabor_id()%>_<%=labor.getNumber()%>">
								...
								<td align="center"><div class="pointer btn_box" number="<%=labor.getNumber()%>" id="list_<%=labor.getLabor_id() %>_<%=labor.getNumber()%>" title="ยืนยันการยกเลิก: [<%=labor.getLabor_id() %>]?" onclick="javascript: if(confirmRemove(this)){removeRepairList(this);}" lang="<%=labor.getLabor_id() %>">ยกเลิก</div></td>
							</tr>
						<%
							}
						%>
